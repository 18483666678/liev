...
font_path = r"D:\PycharmProjects\seq2seq10_24\arial.ttf"
save_path = r"D:\PycharmProjects\seq2seq10_24\save_ckpt/pt"
batch_size = 10
...
class EncoderNet:
    ...
    def __init__(self):
        ...
        # 60*120的图片，10个批次拼接，120为步长，60为数据  现在就变成了N（10*120）* V（60*3） RGB三通道
