...
image_path = r"D:\1028\tensorflowlianxi\code"
font_path = r"D:\1028\tensorflowlianxi\arial.ttf"
#模型保存路径
save_path = r"D:\1028\tensorflowlianxi\save_ckpt/pt"
#批次
batch_size = 100
    ...
    with tf.Session() as sess:
        ...
        for i in range(1000000):
            ...
            if i % 100 == 0:
                ...
                # imgdraw.text((0,0),text=str(output),fill="red",font=font)
                # image.show()
